...
export function CitasProvider ({children}) {
    const [citas, setCitas] = useState(JSON.parse(localStorage.getItem('citas')) ? JSON.parse(localStorage.getItem('citas')) : [new Cita("Nina", "Martin", "2021-08-05", "08:20", "Le duele la pierna"),
